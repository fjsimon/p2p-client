...
public class PeerInfoFormatter {
	...
	public static String peerSourceToString(PeerSource source) {
		switch(source) {
			case SERVER : return StringLocalizer.StringLocalizer("downloadinfowindow.tab.peerlist.column.source.type.server");
			case GLOBAL : return StringLocalizer.StringLocalizer("downloadinfowindow.tab.peerlist.column.source.type.global");
			case KAD : return StringLocalizer.StringLocalizer("downloadinfowindow.tab.peerlist.column.source.type.kad");
			case PEX : return StringLocalizer.StringLocalizer("downloadinfowindow.tab.peerlist.column.source.type.pex");
			case ED2KLINK : return StringLocalizer.StringLocalizer("downloadinfowindow.tab.peerlist.column.source.type.ed2klink");
			case EXTERNAL : return StringLocalizer.StringLocalizer("downloadinfowindow.tab.peerlist.column.source.type.external");
			case INCOMING : return StringLocalizer.StringLocalizer("downloadinfowindow.tab.peerlist.column.source.type.incoming");
		}
		return "";
	}
	...
	public static String formatPeerStatus(PeerDownloadInfo downloadInfo) {
		if (downloadInfo == null)
			return StringLocalizer
					.StringLocalizer("downloadinfowindow.tab.peerlist.column.status.connecting");
		...
		case DISCONNECTED:
			return StringLocalizer
					.StringLocalizer("downloadinfowindow.tab.peerlist.column.status.disconnected");
		case CONNECTED:
			return StringLocalizer
					.StringLocalizer("downloadinfowindow.tab.peerlist.column.status.connected");
		case SLOTREQUEST:
			return StringLocalizer
					.StringLocalizer("downloadinfowindow.tab.peerlist.column.status.slot_request");
		case ACTIVE:
			return StringLocalizer.StringLocalizer("downloadinfowindow.tab.peerlist.column.status.active");
		case ACTIVE_UNUSED:
			return StringLocalizer
					.StringLocalizer("downloadinfowindow.tab.peerlist.column.status.active_unued");
		case IN_QUEUE:
		...
		case INACTIVE:
			return StringLocalizer
					.StringLocalizer("downloadinfowindow.tab.peerlist.column.status.inactive");
		case UPLOAD_REQUEST:
			return StringLocalizer
					.StringLocalizer("downloadinfowindow.tab.peerlist.column.status.upload_request");
		case HASHSET_REQUEST:
			return StringLocalizer
					.StringLocalizer("downloadinfowindow.tab.peerlist.column.status.hashset_request");
		}
