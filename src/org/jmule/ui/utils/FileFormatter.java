...
public class FileFormatter {
	...
	public static String formatMimeType(byte[] fileType) {
		...
		if (Arrays.equals(TAG_FILE_TYPE_AUDIO,fileType)) 
			return StringLocalizer.StringLocalizer("mainwindow.searchtab.column.filetype.audio");
		
		if (Arrays.equals(TAG_FILE_TYPE_VIDEO,fileType)) 
			return StringLocalizer.StringLocalizer("mainwindow.searchtab.column.filetype.video");
		
		if (Arrays.equals(TAG_FILE_TYPE_IMAGE,fileType)) 
			return StringLocalizer.StringLocalizer("mainwindow.searchtab.column.filetype.image");
		
		if (Arrays.equals(TAG_FILE_TYPE_DOC,fileType)) 
			return StringLocalizer.StringLocalizer("mainwindow.searchtab.column.filetype.doc");

		if (Arrays.equals(TAG_FILE_TYPE_PROGRAM,fileType)) 
			return StringLocalizer.StringLocalizer("mainwindow.searchtab.column.filetype.program");
		
		if (Arrays.equals(TAG_FILE_TYPE_ARC,fileType)) 
			return StringLocalizer.StringLocalizer("mainwindow.searchtab.column.filetype.archive");
		
		if (Arrays.equals(TAG_FILE_TYPE_ISO,fileType)) 
			return StringLocalizer.StringLocalizer("mainwindow.searchtab.column.filetype.iso");
		
		return StringLocalizer.StringLocalizer("mainwindow.searchtab.column.filetype.unknown");
	}
