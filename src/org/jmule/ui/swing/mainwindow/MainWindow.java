...
public class MainWindow extends JFrame implements WindowListener  {
			    ...
			    SwingUtilities.invokeLater(new Runnable() {
				    ...
				    public void run() {
				         JOptionPane.showMessageDialog(_this, 
				            StringLocalizer.StringLocalizer("mainwindow.not_enough_space_dialog.message",
											nes.getFileName(),
											FileFormatter.formatFileSize( nes.getTotalSpace() ),
											FileFormatter.formatFileSize( nes.getFreeSpace() )),
				            StringLocalizer.StringLocalizer("mainwindow.not_enough_space_dialog.title"),JOptionPane.ERROR_MESSAGE);
				    }
			    });
			  }
			}
	...
	private void setMainMenu() {
		...
		file.setText(StringLocalizer.StringLocalizer("mainwindow.mainmenu.file"));
		fnew.setText("New");
		view.setText(StringLocalizer.StringLocalizer("mainwindow.mainmenu.view"));
		tabs.setText(StringLocalizer.StringLocalizer("mainwindow.mainmenu.view.tabs"));
		tools.setText(StringLocalizer.StringLocalizer("mainwindow.mainmenu.tools"));
		help.setText(StringLocalizer.StringLocalizer("mainwindow.mainmenu.help"));
		
		exit.setText(StringLocalizer.StringLocalizer("mainwindow.mainmenu.file.exit"));
		...
		import_server_list.setText(StringLocalizer.StringLocalizer("mainwindow.mainmenu.file.import"));
		import_server_list.setIcon(ImgRep.getIcon("import.png"));
		servers.setText(StringLocalizer.StringLocalizer("mainwindow.mainmenu.view.tabs.servers"));
		...
		transfers.setText(StringLocalizer.StringLocalizer("mainwindow.mainmenu.view.tabs.transfers"));
		...
		search.setText(StringLocalizer.StringLocalizer("mainwindow.mainmenu.view.tabs.search"));
		...
		shared_files.setText(StringLocalizer.StringLocalizer("mainwindow.mainmenu.view.tabs.shared"));
		...
		stats.setText(StringLocalizer.StringLocalizer("mainwindow.mainmenu.view.tabs.stats"));
		...
		logs.setText(StringLocalizer.StringLocalizer("mainwindow.mainmenu.view.tabs.logs"));
		...
		ui_chooser.setText(StringLocalizer.StringLocalizer("mainwindow.mainmenu.tools.uichooser"));
		...
		config_wizard.setText(StringLocalizer.StringLocalizer("mainwindow.mainmenu.tools.wizard"));
		...
		options.setText(StringLocalizer.StringLocalizer("mainwindow.mainmenu.tools.options"));
		...
		about.setText(StringLocalizer.StringLocalizer("mainwindow.mainmenu.help.about"));
		about.setIcon(ImgRep.getIcon("menuicons/information.png"));
		
		tool_bar_visibility.setText(StringLocalizer.StringLocalizer("mainwindow.mainmenu.view.toolbar"));
        status_bar_visibility.setText(StringLocalizer.StringLocalizer("mainwindow.mainmenu.view.statusbar"));
	...
	private void setMainButtonsBar() {
		...
		main_buttons_bar.setPreferredSize( new java.awt.Dimension(1024, 60) );
	...
	public enum ServerStatusTypes {
		DISCONNECTED { public String toString() { return StringLocalizer.StringLocalizer("mainwindow.statusbar.label.disconnected"); } },
		CONNECTING { public String toString() { return StringLocalizer.StringLocalizer("mainwindow.statusbar.label.connecting"); }	},
		CONNECTED { public String toString() { return StringLocalizer.StringLocalizer("mainwindow.statusbar.label.connected"); } };
		public abstract String toString();
	}
	
	public enum ClientIDTypes {
		LOW_ID { public String toString() { return StringLocalizer.StringLocalizer("mainwindow.statusbar.label.low_id"); } },
		HIGH_ID { public String toString() { return StringLocalizer.StringLocalizer("mainwindow.statusbar.label.high_id"); } },
	...
	class StatusBar extends JPanel implements Refreshable {
		...
		private JLabel server_status = new JLabel(StringLocalizer.StringLocalizer("mainwindow.statusbar.label.disconnected"));
