	...
	private void init() {
		...
		class PopupListener extends MouseAdapter {
			 ...
			 public PopupListener() {
					...
					add_to_static_list = new JMenuItem(StringLocalizer.StringLocalizer("mainwindow.serverlisttab.serverlist.popupmenu.add_to_static_list"),
					...
					remove_from_static_list = new JMenuItem(StringLocalizer.StringLocalizer("mainwindow.serverlisttab.serverlist.popupmenu.remove_from_static_list"),
