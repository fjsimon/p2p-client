...
public class SearchResultTable extends JMTable {
	...
	private void init() {
		...
		file_name.setHeaderValue(StringLocalizer.StringLocalizer("mainwindow.searchtab.column.filename"));
		...
		file_size.setHeaderValue(StringLocalizer.StringLocalizer("mainwindow.searchtab.column.filesize"));
		...
		availability.setHeaderValue(StringLocalizer.StringLocalizer("mainwindow.searchtab.column.availability"));
		...
		complete_sources.setHeaderValue(StringLocalizer.StringLocalizer("mainwindow.searchtab.column.completesrcs"));
		...
		type.setHeaderValue(StringLocalizer.StringLocalizer("mainwindow.searchtab.column.filetype"));
		...
		file_id.setHeaderValue(StringLocalizer.StringLocalizer("mainwindow.searchtab.column.fileid"));
