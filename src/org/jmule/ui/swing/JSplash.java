...
public final class JSplash extends JWindow implements Splash { 
    ...
    public JSplash() throws MalformedURLException, URISyntaxException {
        super();
//        URL url = JSplash.class.getClassLoader().getResource("org/jmule/ui/resources/splash/splash_logo.png");

        File file = new File("/home/r00t/github/p2p-client/src/org/jmule/ui/resources/splash/splash_logo.png");
        URI uri =  file.toURI();
        URL url = uri.toURL();
