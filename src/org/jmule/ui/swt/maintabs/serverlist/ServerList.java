...
import org.jmule.ui.localizer.StringLocalizer;
...
public class ServerList extends JMTable<Server> implements Refreshable {
	...
	public ServerList(Composite composite, final ServerManager server_manager) {
		...
		addColumn(SWT.LEFT, SWTConstants.SERVER_LIST_NAME_COLUMN_ID,Localizer.get("mainwindow.serverlisttab.serverlist.column.name"), "",width);
		
		width = swt_preferences.getColumnWidth(SWTConstants.SERVER_LIST_CC_COLUMN_ID);
		addColumn(SWT.CENTER, SWTConstants.SERVER_LIST_CC_COLUMN_ID,Localizer.get("mainwindow.serverlisttab.serverlist.column.country_code"), StringLocalizer.StringLocalizer("mainwindow.serverlisttab.serverlist.column.country_code.desc"),width);
		...
		addColumn(SWT.LEFT, SWTConstants.SERVER_LIST_FLAG_COLUMN_ID,Localizer.get("mainwindow.serverlisttab.serverlist.column.country"), "",width);
		if (CountryLocator.getInstance().isServiceDown()) 
		...
		addColumn(SWT.LEFT, SWTConstants.SERVER_LIST_IP_COLUMN_ID, Localizer.get("mainwindow.serverlisttab.serverlist.column.address"), "",width);
		
		width = swt_preferences.getColumnWidth(SWTConstants.SERVER_LIST_DESCRIPTION_COLUMN_ID);
		addColumn(SWT.LEFT, SWTConstants.SERVER_LIST_DESCRIPTION_COLUMN_ID,Localizer.get("mainwindow.serverlisttab.serverlist.column.description"), "",width);
		
		width = swt_preferences.getColumnWidth(SWTConstants.SERVER_LIST_PING_COLUMN_ID);
		addColumn(SWT.RIGHT, SWTConstants.SERVER_LIST_PING_COLUMN_ID,Localizer.get("mainwindow.serverlisttab.serverlist.column.ping"), "",width);
		
		width = swt_preferences.getColumnWidth(SWTConstants.SERVER_LIST_USERS_COLUMN_ID);
		addColumn(SWT.RIGHT, SWTConstants.SERVER_LIST_USERS_COLUMN_ID,Localizer.get("mainwindow.serverlisttab.serverlist.column.users"), "",width);
		
		width = swt_preferences.getColumnWidth(SWTConstants.SERVER_LIST_MAX_USERS_COLUMN_ID);
		addColumn(SWT.RIGHT, SWTConstants.SERVER_LIST_MAX_USERS_COLUMN_ID,Localizer.get("mainwindow.serverlisttab.serverlist.column.max_users"), StringLocalizer.StringLocalizer("mainwindow.serverlisttab.serverlist.column.maxusers.desc"),width);
		
		width = swt_preferences.getColumnWidth(SWTConstants.SERVER_LIST_FILES_COLUMN_ID);
		addColumn(SWT.RIGHT, SWTConstants.SERVER_LIST_FILES_COLUMN_ID,Localizer.get("mainwindow.serverlisttab.serverlist.column.files"), "",width);
		
		width = swt_preferences.getColumnWidth(SWTConstants.SERVER_LIST_SOFT_LIMIT_COLUMN_ID);
		addColumn(SWT.RIGHT, SWTConstants.SERVER_LIST_SOFT_LIMIT_COLUMN_ID,Localizer.get("mainwindow.serverlisttab.serverlist.column.soft_limit"), StringLocalizer.StringLocalizer("mainwindow.serverlisttab.serverlist.column.soft_limit.desc"),width);
		
		width = swt_preferences.getColumnWidth(SWTConstants.SERVER_LIST_HARD_LIMIT_COLUMN_ID);
		addColumn(SWT.RIGHT, SWTConstants.SERVER_LIST_HARD_LIMIT_COLUMN_ID,Localizer.get("mainwindow.serverlisttab.serverlist.column.hard_limit"), StringLocalizer.StringLocalizer("mainwindow.serverlisttab.serverlist.column.hard_limit.desc"),width);
		
		width = swt_preferences.getColumnWidth(SWTConstants.SERVER_LIST_VERSION_COLUMN_ID);
		addColumn(SWT.RIGHT, SWTConstants.SERVER_LIST_VERSION_COLUMN_ID,Localizer.get("mainwindow.serverlisttab.serverlist.column.software"), "",width);
		
		width = swt_preferences.getColumnWidth(SWTConstants.SERVER_LIST_STATIC_COLUMN_ID);
		addColumn(SWT.LEFT, SWTConstants.SERVER_LIST_STATIC_COLUMN_ID,Localizer.get("mainwindow.serverlisttab.serverlist.column.static"), "",width);
		...
		no_servers_server_add.setText (Localizer.get("mainwindow.serverlisttab.serverlist.popupmenu.add_server"));
		...
		no_server_paste_ed2k_links.setText (Localizer.get("mainwindow.serverlisttab.serverlist.popupmenu.paste_ed2k_links"));
		...
		no_server_column_setup.setText (Localizer.get("mainwindow.serverlisttab.serverlist.popupmenu.column_setup"));
		...
		no_selection_menu_add.setText(Localizer.get("mainwindow.serverlisttab.serverlist.popupmenu.add_server"));
		...
		no_selection_menu_disconnect.setText(Localizer.get("mainwindow.serverlisttab.serverlist.popupmenu.disconnect_from"));
		...
		no_selection_menu_remove_all.setText(Localizer.get("mainwindow.serverlisttab.serverlist.popupmenu.remove_all"));
		...
		no_selection_menu_paste_ed2k.setText(Localizer.get("mainwindow.serverlisttab.serverlist.popupmenu.paste_ed2k_links"));
		...
		no_selection_menu_column_setup.setText(Localizer.get("mainwindow.serverlisttab.serverlist.popupmenu.column_setup"));
		...
		selected_server_connect.setText (Localizer.get("mainwindow.serverlisttab.serverlist.popupmenu.connect_to"));
		...
		selected_server_disconnect.setText (Localizer.get("mainwindow.serverlisttab.serverlist.popupmenu.disconnect_from"));
		...
		server_add.setText (Localizer.get("mainwindow.serverlisttab.serverlist.popupmenu.add_server"));
		...
		server_remove.setText (Localizer.get("mainwindow.serverlisttab.serverlist.popupmenu.remove_server"));
		...
		server_remove_all.setText (Localizer.get("mainwindow.serverlisttab.serverlist.popupmenu.remove_all"));
		...
		server_copy_ed2k_link.setText (Localizer.get("mainwindow.serverlisttab.serverlist.popupmenu.copy_ed2k_link"));
		...
		server_paste_ed2k_links.setText (Localizer.get("mainwindow.serverlisttab.serverlist.popupmenu.paste_ed2k_links"));
		...
		add_to_static_list.setText (Localizer.get("mainwindow.serverlisttab.serverlist.popupmenu.add_to_static_list"));
		...
		remove_from_static_list.setText (Localizer.get("mainwindow.serverlisttab.serverlist.popupmenu.remove_from_static_list"));
		...
		column_setup.setText (Localizer.get("mainwindow.serverlisttab.serverlist.popupmenu.column_setup"));
		...
		server_properties.setText (Localizer.get("mainwindow.serverlisttab.serverlist.popupmenu.server_properties"));
		...
		server_remove_selected.setText (Localizer.get("mainwindow.serverlisttab.serverlist.popupmenu.remove_selected"));
		...
		server_remove_all_multiselect.setText (Localizer.get("mainwindow.serverlisttab.serverlist.popupmenu.remove_all"));
		...
		server_connect_multiselect.setText (Localizer.get("mainwindow.serverlisttab.serverlist.popupmenu.connect"));
		...
		server_disconnect_multiselect.setText (Localizer.get("mainwindow.serverlisttab.serverlist.popupmenu.disconnect_from"));
		...
		multi_select_menu_copy_ed2k_links.setText (Localizer.get("mainwindow.serverlisttab.serverlist.popupmenu.copy_ed2k_links"));
		...
		multi_select_menu_paste_ed2k_links.setText (Localizer.get("mainwindow.serverlisttab.serverlist.popupmenu.paste_ed2k_links"));
		...
		multisel_add_to_static_list.setText (Localizer.get("mainwindow.serverlisttab.serverlist.popupmenu.add_to_static_list"));
		...
		multisel_remove_from_static_list.setText (Localizer.get("mainwindow.serverlisttab.serverlist.popupmenu.remove_from_static_list"));
	...
	protected Menu getPopUpMenu() {
		...
		if (wrapper.isAutoconnecting()) {
			...
			selected_server_disconnect.setText(Localizer.get("mainwindow.serverlisttab.serverlist.popupmenu.cancel"));
			
			server_disconnect_multiselect.setEnabled(true);
			server_disconnect_multiselect.setImage(SWTImageRepository.getImage("auto_connect_cancel.png"));
			server_disconnect_multiselect.setText(Localizer.get("mainwindow.serverlisttab.serverlist.popupmenu.cancel"));
		} else {
			...
			public void JMRun() {
				...
				try {
					...
					SWTThread.getDisplay().asyncExec(new JMRunnable() {
						public void JMRun() {
							Utils.showWarningMessage(getShell(), Localizer.get("mainwindow.serverlisttab.serverlist.server_list_store_error_title"),
									Localizer.get("mainwindow.serverlisttab.serverlist.server_list_store_error"));
							MainWindow.getLogger().error(Localizer.get("mainwindow.logtab.error_serverlist_save_failed"));
						}
					});
				}}}).start();
	}
	...
	private void removeSelectedServers() {
		...
		boolean result;
		if ( list.size()== 1)
			result = Utils.showConfirmMessage(getShell(),Localizer.get("mainwindow.serverlisttab.serverlist.server_delete_confirm_title"), Localizer.get("mainwindow.serverlisttab.serverlist.server_delete_confirm"));
		else
			result = Utils.showConfirmMessage(getShell(),Localizer.get("mainwindow.serverlisttab.serverlist.server_delete_confirm_title"), Localizer.get("mainwindow.serverlisttab.serverlist.servers_delete_confirm"));
		if (result) 
			new JMThread(new JMRunnable() {
				public void JMRun() {
	...
	private void clearServerList() {
		boolean returnvalue = Utils.showConfirmMessage(getShell(),Localizer.get("mainwindow.serverlisttab.serverlist.clear_confirm_title"), Localizer.get("mainwindow.serverlisttab.serverlist.clear_confirm"));
		if (returnvalue) {
			new JMThread( new JMRunnable() {
				public void JMRun() {
	...
	public void updateRow(Server server) {
		...
		if (server.isStatic())
			setRowText(server, SWTConstants.SERVER_LIST_STATIC_COLUMN_ID, StringLocalizer.StringLocalizer("mainwindow.serverlisttab.serverlist.column.static.yes"));
		else
			setRowText(server, SWTConstants.SERVER_LIST_STATIC_COLUMN_ID, StringLocalizer.StringLocalizer("mainwindow.serverlisttab.serverlist.column.static.no"));
	}
