...
public class ServerPropertiesWindow implements JMuleUIComponent,Refreshable {
	...
	public void initUIComponents() {
		...
		shell.setText(Localizer.get("serverpropertieswindow.title"));
		...
		label.setText(Localizer.get("serverpropertieswindow.label.server_address")+" : ");
		...
		if (!country_locator.isServiceDown()) {
			...
			if (country_name.equals(CountryLocator.COUNTRY_NAME_NOT_AVAILABLE))
				country_name = Localizer.get("serverpropertieswindow.label.country.unknown_name");
			if (country_code.equals(CountryLocator.COUNTRY_CODE_NOT_AVAILABLE))
				country_code = Localizer.get("serverpropertieswindow.label.country.unknown_code");
		...
		label = new Label(server_fields,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.get("serverpropertieswindow.label.server_name") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(server_fields,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.get("serverpropertieswindow.label.server_description") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(server_fields,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.get("serverpropertieswindow.label.server_users") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(server_fields,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.get("serverpropertieswindow.label.server_files") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(server_fields,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.get("serverpropertieswindow.label.server_ping") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(server_fields,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.get("serverpropertieswindow.label.server_hard_limit") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(server_fields,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.get("serverpropertieswindow.label.server_soft_limit") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(server_fields,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.get("serverpropertieswindow.label.version") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(server_fields,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.get("serverpropertieswindow.label.ed2k_link") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label.setToolTipText(StringLocalizer.StringLocalizer("serverpropertieswindow.label.ed2k_link.tooltip"));
		...
		button.setText(Localizer.get("serverpropertieswindow.close"));
		button.setFocus();
