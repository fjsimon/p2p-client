...
public class SharedTab extends AbstractTab {
	...
	private void removeSelectedDir() {
		if (!Utils.showConfirmMessage(getShell(), StringLocalizer.StringLocalizer("mainwindow.sharedtab.confirm_remove_shared_dir_title"),
	...
	private void clearDirList() {
		if (!Utils.showConfirmMessage(getShell(), StringLocalizer.StringLocalizer("mainwindow.sharedtab.confirm_clear_dir_list_title"),
	...
	private void removeFromDisk() {
		if (!Utils.showConfirmMessage(getShell(), StringLocalizer.StringLocalizer("mainwindow.sharedtab.confirm_remove_from_disk_title"),
