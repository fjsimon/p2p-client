...
public class UploadGeneralTab extends CTabItem implements Refreshable {
	...
	public UploadGeneralTab(CTabFolder tabFolder, UploadSession session) {
		...
		setText(Localizer.get("uploadinfowindow.tab.general.title"));
		...
		general.setText(Localizer.get("uploadinfowindow.tab.general.title"));
		general.setLayoutData(new GridData(GridData.FILL_HORIZONTAL));
		
		label = new Label(general,SWT.NONE);
		label.setText(Localizer.get("uploadinfowindow.tab.general.label.filename")+" : ");
		...
		label = new Label(general,SWT.NONE);
		label.setText(Localizer.get("uploadinfowindow.tab.general.label.filehash")+" : ");
		label.setFont(skin.getLabelFont());
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		label = new Label(general,SWT.NONE);
		label.setLayoutData(new GridData(GridData.FILL_HORIZONTAL));
		...
		label = new Label(general,SWT.NONE);
		label.setText(Localizer.get("uploadinfowindow.tab.general.label.filesize")+" : ");
		label.setFont(skin.getLabelFont());
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		label = new Label(general,SWT.NONE);
		label.setLayoutData(new GridData(GridData.FILL_HORIZONTAL));
		...
		label = new Label(general,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.get("uploadinfowindow.tab.general.label.ed2k_link") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label.setToolTipText(StringLocalizer.StringLocalizer("uploadinfowindow.tab.general.label.ed2k_link.tooltip"));
		label.setForeground(SWTThread.getDisplay().getSystemColor(SWT.COLOR_BLUE));
		...
		transfer.setText(Localizer.get("uploadinfowindow.tab.general.group.transfer"));
		transfer.setLayoutData(new GridData(GridData.FILL_BOTH));
		
		label = new Label(transfer,SWT.NONE);
		label.setText(Localizer.get("uploadinfowindow.tab.transfer.label.uploadspeed")+" : ");
		label.setFont(skin.getLabelFont());
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(transfer,SWT.NONE);
		label.setText(Localizer.get("uploadinfowindow.tab.transfer.label.transferred")+" : ");
		label.setFont(skin.getLabelFont());
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(transfer,SWT.NONE);
		label.setText(Localizer.get("uploadinfowindow.tab.transfer.label.eta")+" : ");
		label.setFont(skin.getLabelFont());
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(transfer,SWT.NONE);
		label.setText(Localizer.get("uploadinfowindow.tab.transfer.label.peers")+" : ");
		label.setFont(skin.getLabelFont());
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
