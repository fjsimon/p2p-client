	...
	public TransfersTab(Composite shell,JMuleCore core) {
		...
		refreshable = new Refreshable() {
			public void refresh() {
				...
				downloads.setText(Localizer.get("mainwindow.transferstab.downloads")+"("+download_count+")");
				uploads.setText(Localizer.get("mainwindow.transferstab.uploads")+"("+upload_count+")");
			}
		};
		refreshable.refresh();
	}
