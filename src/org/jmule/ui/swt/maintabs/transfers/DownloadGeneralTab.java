...
public class DownloadGeneralTab extends CTabItem implements Refreshable {
	...
	public DownloadGeneralTab(CTabFolder tabFolder,
		...
		setText(Localizer.get("downloadinfowindow.tab.general.title"));
		SWTSkin skin = null;
		try {
		...
		transfer_group.setText(Localizer
				.get("downloadinfowindow.tab.general.group.transfer"));
		...
		label.setText(Localizer
				.get("downloadinfowindow.tab.general.label.status")
				+ " : ");
		...
		download_status
				.setText(download_session.getStatus() == DownloadStatus.STARTED ? Localizer
						.get("mainwindow.transferstab.downloads.column.status.started")
						: Localizer
								.get("mainwindow.transferstab.downloads.column.status.stopped"));

		label = new Label(transfer_group, SWT.NONE);
		label.setText(Localizer
				.get("downloadinfowindow.tab.general.label.totalprogress")
				+ " : ");
		label.setFont(skin.getLabelFont());
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(transfer_group, SWT.NONE);
		label.setText(Localizer
				.get("downloadinfowindow.tab.general.label.sources")
				+ " : ");
		label.setFont(skin.getLabelFont());
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(transfer_group, SWT.NONE);
		label.setText(Localizer
				.get("downloadinfowindow.tab.general.label.filesize")
				+ " : ");
		label.setFont(skin.getLabelFont());
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		label = new Label(transfer_group, SWT.NONE);
		...
		label = new Label(transfer_group, SWT.NONE);
		label.setText(Localizer
				.get("downloadinfowindow.tab.general.label.transferred")
				+ " : ");
		label.setFont(skin.getLabelFont());
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(transfer_group, SWT.NONE);
		label.setText(Localizer
				.get("downloadinfowindow.tab.general.label.remaining")
				+ " : ");
		label.setFont(skin.getLabelFont());
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(transfer_group, SWT.NONE);
		label.setText(Localizer.get("downloadinfowindow.tab.general.label.parts")
				+ " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		label.setFont(skin.getLabelFont());
		...
		part_status
				.setText(download_session.getPartCount()
						+ "; "
						+ Localizer
								.get("downloadinfowindow.tab.general.label.parts_available")
						+ " : " + download_session.getAvailablePartCount());

		label = new Label(transfer_group, SWT.NONE);
		label.setText(Localizer
				.get("downloadinfowindow.tab.general.label.download_speed")
				+ " : ");
		label.setFont(skin.getLabelFont());
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(transfer_group, SWT.NONE);
		label.setText(Localizer.get("downloadinfowindow.tab.general.label.eta")
				+ " : ");
		label.setFont(skin.getLabelFont());
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		general_group.setText(Localizer.get("downloadinfowindow.group.general"));
		general_group.setLayoutData(new GridData(GridData.FILL_HORIZONTAL));

		label = new Label(general_group, SWT.NONE);
		label.setText(Localizer
				.get("downloadinfowindow.tab.general.label.filename")
				+ " : ");
		label.setFont(skin.getLabelFont());
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		label = new Label(general_group, SWT.NONE);
		...
		label = new Label(general_group, SWT.NONE);
		label.setText(Localizer
				.get("downloadinfowindow.tab.general.label.partmet")
				+ " : ");
		label.setFont(skin.getLabelFont());
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		label = new Label(general_group, SWT.NONE);
		...
		label = new Label(general_group, SWT.NONE);
		label.setText(Localizer
				.get("downloadinfowindow.tab.general.label.filehash")
				+ " : ");
		label.setFont(skin.getLabelFont());
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		label = new Label(general_group, SWT.NONE);
		...
		label.setFont(skin.getLabelFont());
		label.setText(Localizer
				.get("downloadinfowindow.tab.general.label.ed2k_link")
				+ " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label.setToolTipText(StringLocalizer
				.StringLocalizer("downloadinfowindow.tab.general.label.ed2k_link.tooltip"));
		label.setForeground(SWTThread.getDisplay().getSystemColor(
				SWT.COLOR_BLUE));
