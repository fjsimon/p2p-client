...
public class LogsTab extends AbstractTab implements Logger {
	...
	public LogsTab(Composite shell) {
		...
		copy_item.setText(StringLocalizer.StringLocalizer("mainwindow.logtab.popupmenu.copy"));
		...
		save_item.setText(StringLocalizer.StringLocalizer("mainwindow.logtab.popupmenu.save"));
		...
		select_all_item.setText(StringLocalizer.StringLocalizer("mainwindow.logtab.popupmenu.select_all"));
		...
		clear_item.setText(StringLocalizer.StringLocalizer("mainwindow.logtab.popupmenu.clear"));
