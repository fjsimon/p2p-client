...
public class SearchResultTab {
	...
	public SearchResultTab(CTabFolder parent, SearchQuery searchRequest, JMuleCore core) {
		...
		search_results.addColumn(SWT.LEFT,
				SWTConstants.SEARCH_FILENAME_COLUMN_ID, StringLocalizer
						.StringLocalizer("mainwindow.searchtab.column.filename"), "", width);

		width = swt_preferences
				.getColumnWidth(SWTConstants.SEARCH_FILESIZE_COLUMN_ID);
		search_results.addColumn(SWT.RIGHT,
				SWTConstants.SEARCH_FILESIZE_COLUMN_ID, StringLocalizer
						.StringLocalizer("mainwindow.searchtab.column.filesize"), "", width);

		width = swt_preferences
				.getColumnWidth(SWTConstants.SEARCH_FILEQUALITY_COLUMN_ID);
		search_results.addColumn(SWT.CENTER,
				SWTConstants.SEARCH_FILEQUALITY_COLUMN_ID, "", StringLocalizer
						.StringLocalizer("mainwindow.searchtab.column.desc.filequality"),
				width);

		width = swt_preferences
				.getColumnWidth(SWTConstants.SEARCH_AVAILABILITY_COLUMN_ID);
		search_results.addColumn(SWT.RIGHT,
				SWTConstants.SEARCH_AVAILABILITY_COLUMN_ID, StringLocalizer
						.StringLocalizer("mainwindow.searchtab.column.availability"), "",
				width);

		width = swt_preferences
				.getColumnWidth(SWTConstants.SEARCH_COMPLETESRC_COLUMN_ID);
		search_results.addColumn(SWT.RIGHT,
				SWTConstants.SEARCH_COMPLETESRC_COLUMN_ID, StringLocalizer
						.StringLocalizer("mainwindow.searchtab.column.completesrcs"), "",
				width);

		width = swt_preferences
				.getColumnWidth(SWTConstants.SEARCH_FILE_TYPE_COLUMN_ID);
		search_results.addColumn(SWT.LEFT,
				SWTConstants.SEARCH_FILE_TYPE_COLUMN_ID, StringLocalizer
						.StringLocalizer("mainwindow.searchtab.column.filetype"), "", width);

		width = swt_preferences
				.getColumnWidth(SWTConstants.SEARCH_FILE_ID_COLUMN_ID);
		search_results.addColumn(SWT.LEFT,
				SWTConstants.SEARCH_FILE_ID_COLUMN_ID, StringLocalizer
						.StringLocalizer("mainwindow.searchtab.column.fileid"), "", width);
		...
		no_items_close_tab.setText(StringLocalizer.StringLocalizer("mainwindow.searchtab.popupmenu.close"));
		...
		MenuItem no_items_column_setup_item = new MenuItem(no_items_menu,
				SWT.PUSH);
		no_items_column_setup_item.setText(StringLocalizer
				.StringLocalizer("mainwindow.searchtab.popupmenu.column_setup"));
		...
		download_item.setText(StringLocalizer.StringLocalizer("mainwindow.searchtab.popupmenu.download"));
		...
		try_again.setText(StringLocalizer.StringLocalizer("mainwindow.searchtab.popupmenu.try_again"));
		...
		copy_ed2k_item.setText(StringLocalizer
				.StringLocalizer("mainwindow.searchtab.popupmenu.copy_ed2k_link"));
		...
		close_item.setText(StringLocalizer.StringLocalizer("mainwindow.searchtab.popupmenu.close"));
		...
		column_setup_item.setText(StringLocalizer
				.StringLocalizer("mainwindow.searchtab.popupmenu.column_setup"));
		...
		properties_item.setText(StringLocalizer
				.StringLocalizer("mainwindow.searchtab.popupmenu.properties"));
