...
public abstract class AdvancedSearchWindow implements JMuleUIComponent{
	...
	public void initUIComponents() {
		...
		shell.setText(StringLocalizer.StringLocalizer("advancedsearchwindow.title"));
		...
		label.setText(StringLocalizer.StringLocalizer("advancedsearchwindow.label.min_size") + " : ");
		...
		label = new Label(file_size_options,SWT.NONE);
		label.setText(StringLocalizer.StringLocalizer("advancedsearchwindow.label.max_size") + " : ");
		...
		file_type.add(StringLocalizer.StringLocalizer("advancedsearchwindow.file_type.any"));
		file_type.add(StringLocalizer.StringLocalizer("advancedsearchwindow.file_type.archive"));
		file_type.add(StringLocalizer.StringLocalizer("advancedsearchwindow.file_type.audio"));
		file_type.add(StringLocalizer.StringLocalizer("advancedsearchwindow.file_type.cd_image"));
		file_type.add(StringLocalizer.StringLocalizer("advancedsearchwindow.file_type.document"));
		file_type.add(StringLocalizer.StringLocalizer("advancedsearchwindow.file_type.pictures"));
		file_type.add(StringLocalizer.StringLocalizer("advancedsearchwindow.file_type.program"));
		file_type.add(StringLocalizer.StringLocalizer("advancedsearchwindow.file_type.video"));
		...
		label = new Label(options_composite,SWT.NONE);
		label.setText(StringLocalizer.StringLocalizer("advancedsearchwindow.label.extension") + " : ");
		layout_data = new GridData();
		layout_data.horizontalAlignment = SWT.RIGHT;
		label.setLayoutData(layout_data);
		...
		label = new Label(options_composite,SWT.NONE);
		label.setText(StringLocalizer.StringLocalizer("advancedsearchwindow.label.availability") + " : ");
		layout_data = new GridData();
		layout_data.horizontalAlignment = SWT.RIGHT;
		label.setLayoutData(layout_data);
		...
		label = new Label(options_composite,SWT.NONE);
		label.setText(StringLocalizer.StringLocalizer("advancedsearchwindow.label.complete_sources") + " : ");
		layout_data = new GridData();
		layout_data.horizontalAlignment = SWT.RIGHT;
		label.setLayoutData(layout_data);
		...
		button_clear.setText(StringLocalizer.StringLocalizer("advancedsearchwindow.button.clear"));
		...
		button_ok.setText(StringLocalizer.StringLocalizer("advancedsearchwindow.button.ok"));
		...
		button_cancel.setText(StringLocalizer.StringLocalizer("advancedsearchwindow.button.cancel"));
