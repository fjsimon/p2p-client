...
public class ServerListImportWindow implements JMuleUIComponent{
	...
	public void initUIComponents() {
		...
		shell.setText(StringLocalizer.StringLocalizer("serverlistimportwindow.title"));
		...
		label.setText(StringLocalizer.StringLocalizer("serverlistimportwindow.label.file_path")+" : ");
		...
		browse_button.setText(StringLocalizer.StringLocalizer("serverlistimportwindow.button.browse"));
		...
		ok_button.setText(StringLocalizer.StringLocalizer("serverlistimportwindow.button.ok"));
		...
		cancel_button.setText(StringLocalizer.StringLocalizer("serverlistimportwindow.button.cancel"));
		...
		SWTThread.getDisplay().asyncExec(new JMRunnable() {
			public void JMRun() {
				...
				try {
					...
					Utils.showWarningMessage(shell, StringLocalizer.StringLocalizer("serverlistimportwindow.import_failed_title"),
							StringLocalizer.StringLocalizer("serverlistimportwindow.import_failed")+"\n"+e.getLocalizedMessage());
				}
