...
public class NightlyBuildWarningWindow implements JMuleUIComponent {
	...
	public void initUIComponents() {
		...
		shell.setText(StringLocalizer.StringLocalizer("nightlybuildwarningwindow.title"));
		...
		window_message.setText(StringLocalizer.StringLocalizer("nightlybuildwarningwindow.label.message1"));
		...
		MouseAdapter link_listener = new MouseAdapter() {
			public void mouseDoubleClick(MouseEvent arg0) {
				...
				if (!Utils.launchProgram(path)) 
					Utils.showWarningMessage(shell, StringLocalizer.StringLocalizer("nightlybuildwarningwindow.error_open_url.title")
							, Localizer.get("nightlybuildwarningwindow.error_open_url",path));
			}
		...
		window_message2.setText(StringLocalizer.StringLocalizer("nightlybuildwarningwindow.label.message2")+" " + (StringLocalizer.StringLocalizer("nightlybuildwarningwindow.label.forum")));
		...
		button_check.setText(StringLocalizer.StringLocalizer("nightlybuildwarningwindow.label.show_at_startup"));
		...
		button.forceFocus();
		button.setText(StringLocalizer.StringLocalizer("nightlybuildwarningwindow.button.ok"));
