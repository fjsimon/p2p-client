	...
	private void change_icon() {
		switch(status) {
			case STATUS_CONNECTING : {
				setText(Localizer.get("mainwindow.toolbar.connect_item.cancel"));
				setImage(SWTImageRepository.getImage("connect_stop.png"));
				break;
			}
			
			case STATUS_CONNECTED : {
				setText(Localizer.get("mainwindow.toolbar.connect_item.disconnect"));
				setImage(SWTImageRepository.getImage("connect_drop.png"));
				break;
			}
			
			case STATUS_DISCONNECTED : {
				setText(Localizer.get("mainwindow.toolbar.connect_item.connect"));
