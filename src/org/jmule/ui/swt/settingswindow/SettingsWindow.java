...
public class SettingsWindow implements JMuleUIComponent {
	...
	public void initUIComponents() {
		...
		shell.setText(StringLocalizer.StringLocalizer("settingswindow.title"));
		...
		button_ok.setText(StringLocalizer.StringLocalizer("settingswindow.button.ok"));
		...
		button_cancel.setText(StringLocalizer.StringLocalizer("settingswindow.button.cancel"));
		...
		button_apply.setText(StringLocalizer.StringLocalizer("settingswindow.button.apply"));
