...
public class AboutWindow implements JMuleUIComponent {
	...
	public void initUIComponents() {
		...
		MouseAdapter link_listener = new MouseAdapter() {
			public void mouseDoubleClick(MouseEvent arg0) {
				...
				if (!Utils.launchProgram(path)) 
					Utils.showWarningMessage(shell, StringLocalizer.StringLocalizer("aboutwindow.error_open_url.title")
							, Localizer.get("aboutwindow.error_open_url",path));
			}
		...
		general_tab.setText(StringLocalizer.StringLocalizer("aboutwindow.tab.general"));
		layout = new GridLayout(1,false);
		layout.marginTop +=10;
		...
		about_text.setText(StringLocalizer.StringLocalizer("aboutwindow.tab.general.label.about"));
		...
		link.setText(StringLocalizer.StringLocalizer("aboutwindow.tab.general.label.home_page") + " : ");
		link = new CLabel(links_container,SWT.NONE);
		...
		link = new CLabel(links_container,SWT.NONE);
		link.setText(StringLocalizer.StringLocalizer("aboutwindow.tab.general.label.forum") + " : ");
		...
		if (JMConstants.IS_NIGHTLY_BUILD) {
			...
			nightly_build.setText(StringLocalizer.StringLocalizer("aboutwindow.tab.nightly_build"));
			layout = new GridLayout(1,false);
			...
			nightly_build_label.setText(StringLocalizer.StringLocalizer("aboutwindow.tab.nightly_build.label.nightly_buld_str1"));
			...
			nightly_build_label2.setText(StringLocalizer.StringLocalizer("aboutwindow.tab.nightly_build.label.nightly_buld_str2")+" "+ StringLocalizer.StringLocalizer("aboutwindow.tab.general.label.forum"));
		...
		environment_tab.setText(StringLocalizer.StringLocalizer("aboutwindow.tab.environment"));
		...
		table.addColumn(SWT.LEFT, 1, StringLocalizer.StringLocalizer("aboutwindow.tab.environment.table.column.key"), "", 200);
		table.addColumn(SWT.LEFT, 2, StringLocalizer.StringLocalizer("aboutwindow.tab.environment.table.column.value"), "", 500);
		...
		license_tab.setText(StringLocalizer.StringLocalizer("aboutwindow.tab.license"));
		...
		button_ok.setText(StringLocalizer.StringLocalizer("aboutwindow.button.ok"));
		...
		shell.setText(Localizer.get("aboutwindow.title"));
