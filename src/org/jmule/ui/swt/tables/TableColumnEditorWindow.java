...
public class TableColumnEditorWindow {
  ...
  public TableColumnEditorWindow(final Table editTable,Shell parent,
	...
	shell.setText(Localizer.get("columneditorwindow.title"));
    ...
    label.setText(Localizer.get("columneditorwindow.draghint"));
    ...
    bOk.setText(Localizer.get("mainwindow.button.ok"));
    rd = new RowData();
    rd.width = 70;
    ...
    bCancel.setText(Localizer.get("mainwindow.button.cancel"));
    rd = new RowData();
    rd.width = 70;
    ...
    bApply.setText(Localizer.get("mainwindow.button.apply"));
    rd = new RowData();
    rd.width = 70;
    ...
    column.setText(Localizer.get("columneditorwindow.column.column_name"));
    column = new TableColumn(table, SWT.NONE);
    column.setText(Localizer.get("columneditorwindow.column.description"));
