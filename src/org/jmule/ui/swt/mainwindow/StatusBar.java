...
public class StatusBar extends Composite {
	...
	public StatusBar(Composite parent,JMuleCore core) {
		...
		connection_status_label.setText(Localizer.get("mainwindow.statusbar.label.disconnected"));
	...
	public void setStatusConnecting() {
		connection_status_label.setText(Localizer.get("mainwindow.statusbar.label.connecting"));
		Image img = SWTImageRepository.getImage("toolbar_disconnected.png");
		img_label.setImage(img);
		client_id_label.setForeground(SWTThread.getDisplay().getSystemColor(SWT.COLOR_BLACK));
		client_id_label.setText("");
	...
	public void setStatusConnected(Server server) {
		...
		connection_status_label.setText(Localizer.get("mainwindow.statusbar.label.connected"));
		connection_status_label.setToolTipText(server.getAddress() + ":" + server.getPort());
		client_id_label.setText(client_id.isHighID() ? Localizer.get("mainwindow.statusbar.label.high_id") :Localizer.get("mainwindow.statusbar.label.low_id"));
	...
	private void showDownSpeedLimitScaleWindow() {
		SpeedScaleShell speedScaleWidget = new SpeedScaleShell(StringLocalizer.StringLocalizer("mainwindow.statusbar.speed_scale.download") + " :");
		long down_limit = 0;
		try {
		...
		speedScaleWidget.addOption(StringLocalizer.StringLocalizer("mainwindow.statusbar.speed_scale.no_limit"), 0);
	...
	private void showUpSpeedLimitScaleWindow() {
		SpeedScaleShell speedScaleWidget = new SpeedScaleShell(StringLocalizer.StringLocalizer("mainwindow.statusbar.speed_scale.upload") + " :");
		long up_limit = 0;
		try {
