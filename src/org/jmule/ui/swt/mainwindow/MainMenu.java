...
public class MainMenu extends Menu{
	...
	public MainMenu(Shell shell, final MainWindow mainWindow) {
		...
		fileItem.setText (Localizer.get("mainwindow.mainmenu.file"));
		
		Menu submenu = new Menu (shell, SWT.DROP_DOWN);
		fileItem.setMenu (submenu);

		MenuItem new_item = new MenuItem(submenu,SWT.CASCADE);
		new_item.setText(StringLocalizer.StringLocalizer("mainwindow.mainmenu.file.new"));
		...
		new_server_item.setText(StringLocalizer.StringLocalizer("mainwindow.mainmenu.file.new.new_server"));
		...
		new_download_item.setText(StringLocalizer.StringLocalizer("mainwindow.mainmenu.file.new.new_download"));
		...
		new_shared_folder_item.setText(StringLocalizer.StringLocalizer("mainwindow.mainmenu.file.new.new_shared_dir"));
		...
		import_servers.setText(Localizer.get("mainwindow.mainmenu.file.import"));
		...
		exit_item.setText(Localizer.get("mainwindow.mainmenu.file.exit"));
		...
		kad_item.setText(Localizer.get("mainwindow.mainmenu.view.tabs.kad"));
		...
		transfers_item.setText(Localizer.get("mainwindow.mainmenu.view.tabs.transfers"));
		...
		search_item.setText(Localizer.get("mainwindow.mainmenu.view.tabs.search"));
		...
		shared_item.setText(Localizer.get("mainwindow.mainmenu.view.tabs.shared"));
		...
		stats_item.setText(Localizer.get("mainwindow.mainmenu.view.tabs.stats"));
		...
		log_item.setText(Localizer.get("mainwindow.mainmenu.view.tabs.logs"));
		...
		toolbar_item.setText(Localizer.get("mainwindow.mainmenu.view.toolbar"));
		...
		status_item.setText(Localizer.get("mainwindow.mainmenu.view.statusbar"));
		...
		toolsItem.setText (Localizer.get("mainwindow.mainmenu.tools"));
		submenu = new Menu (shell, SWT.DROP_DOWN);
		...
		gui_chooser_item.setText(Localizer.get("mainwindow.mainmenu.tools.uichooser"));
		...
		wizard_item.setText(Localizer.get("mainwindow.mainmenu.tools.wizard"));
		...
		options_item.setText(Localizer.get("mainwindow.mainmenu.tools.options"));
		...
		helpItem.setText (Localizer.get("mainwindow.mainmenu.help"));

		submenu = new Menu (shell, SWT.DROP_DOWN);
		helpItem.setMenu (submenu);
		
		MenuItem open_support_item = new MenuItem (submenu, SWT.PUSH);
		open_support_item.setText(Localizer.get("mainwindow.mainmenu.help.open_support"));
		...
		bugtracker_item.setText(Localizer.get("mainwindow.mainmenu.help.bug_tracker"));
		...
		forum_item.setText(Localizer.get("mainwindow.mainmenu.help.forum"));
		...
		update_check_item.setText(Localizer.get("mainwindow.mainmenu.help.updatecheck"));
		...
		about_item.setText(Localizer.get("mainwindow.mainmenu.help.about"));
