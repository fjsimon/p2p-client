...
import static org.jmule.ui.localizer.StringLocalizer.StringLocalizer;
...
public class Toolbar extends ToolBar {
	...
	public Toolbar(Composite shell,JMuleCore core, MainWindow mainWindow) {
		...
		servers_item.setText(StringLocalizer.StringLocalizer("mainwindow.toolbar.servers_item"));
		...
		kad_item.setText(StringLocalizer.StringLocalizer("mainwindow.toolbar.kad_item"));
		...
		transfers_item.setText(StringLocalizer.StringLocalizer("mainwindow.toolbar.transfers_item"));
		...
		search_item.setText(StringLocalizer.StringLocalizer("mainwindow.toolbar.search_item"));
		...
		shared_item.setText(StringLocalizer.StringLocalizer("mainwindow.toolbar.shared_item"));
		...
		statistics_item.setText(StringLocalizer.StringLocalizer("mainwindow.toolbar.statistics_item"));
		...
		logs_item.setText(StringLocalizer.StringLocalizer("mainwindow.toolbar.logs_item"));
