...
public class NewWindow implements JMuleUIComponent {
	...
	public void initUIComponents() {
		if (type == WindowType.SHARED_DIR) {
			...
			dir_dialog.setText(StringLocalizer.StringLocalizer("newwindow.title.shared_dir"));
		...
		if	(type == WindowType.DOWNLOAD) {
			shell.setText(StringLocalizer.StringLocalizer("newwindow.title.download"));
			shell.setImage(SWTImageRepository.getMenuImage("folder_down.png"));
		}
		else {
			shell.setText(StringLocalizer.StringLocalizer("newwindow.title.server"));
		...
		learn_more_link.setText(StringLocalizer.StringLocalizer("newwindow.label.about_ed2k_links"));
		...
		learn_more_link.addMouseListener(new MouseAdapter() {	
				public void mouseDoubleClick(MouseEvent arg0) {
					...
					if (!Utils.launchProgram(path)) 
						Utils.showWarningMessage(shell, StringLocalizer.StringLocalizer("newwindow.error_open_url.title")
								, Localizer.get("newwindow.error_open_url",path));
				}
		...
		button_paste_ed2k_link.setText(StringLocalizer.StringLocalizer("newwindow.button.paste_ed2k_link"));
		...
		button_clear.setText(StringLocalizer.StringLocalizer("newwindow.button.clear"));
		...
		button_ok.setText(StringLocalizer.StringLocalizer("newwindow.button.ok"));
		...
		button_cancel.setText(StringLocalizer.StringLocalizer("newwindow.button.cancel"));
	...
	private class DownloadList extends JMTable<ED2KFileLink> implements GenericTable {
		...
		public DownloadList(Composite composite) {
			...
			addColumn(SWT.LEFT, SWTConstants.NEW_DOWNLOAD_LIST_FILE_NAME_COLUMN_ID, StringLocalizer.StringLocalizer("newwindow.column.file_name"), StringLocalizer.StringLocalizer("newwindow.column.file_name.desc"), SWTPreferences.getInstance().getColumnWidth(SWTConstants.NEW_DOWNLOAD_LIST_FILE_NAME_COLUMN_ID));
			addColumn(SWT.LEFT, SWTConstants.NEW_DOWNLOAD_LIST_FILE_SIZE_COLUMN_ID, StringLocalizer.StringLocalizer("newwindow.column.file_size"), StringLocalizer.StringLocalizer("newwindow.column.file_size.desc"), SWTPreferences.getInstance().getColumnWidth(SWTConstants.NEW_DOWNLOAD_LIST_FILE_SIZE_COLUMN_ID));
			addColumn(SWT.LEFT, SWTConstants.NEW_DOWNLOAD_LIST_FILE_ID_COLUMN_ID,   StringLocalizer.StringLocalizer("newwindow.column.file_id"), StringLocalizer.StringLocalizer("newwindow.column.file_id.desc"), 	   SWTPreferences.getInstance().getColumnWidth(SWTConstants.NEW_DOWNLOAD_LIST_FILE_ID_COLUMN_ID));
			setSorting(false);
			...
			paste_ed2k.setText(StringLocalizer.StringLocalizer("newwindow.menu.paste_ed2k_link"));
	...
	private class ServerList extends JMTable<ED2KServerLink> implements GenericTable {
		...
		public ServerList(Composite composite) {
			super(composite, SWT.CHECK);
			addColumn(SWT.LEFT, SWTConstants.NEW_SERVER_LIST_NAME_COLUMN_ID, StringLocalizer.StringLocalizer("newwindow.column.server_name"), StringLocalizer.StringLocalizer("newwindow.column.server_name.desc"), SWTPreferences.getInstance().getColumnWidth(SWTConstants.NEW_SERVER_LIST_NAME_COLUMN_ID));
			addColumn(SWT.LEFT, SWTConstants.NEW_SERVER_LIST_PORT_COLUMN_ID, StringLocalizer.StringLocalizer("newwindow.column.server_port"), StringLocalizer.StringLocalizer("newwindow.column.server_port"), SWTPreferences.getInstance().getColumnWidth(SWTConstants.NEW_SERVER_LIST_PORT_COLUMN_ID));
