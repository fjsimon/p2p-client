...
public class GeneralTab extends AbstractSettingsTreeItem {
	...
	public GeneralTab(Composite parent) {
		...
		label.setText(StringLocalizer.StringLocalizer("settingswindow.tab.general.label.nickname") + " : ");
		...
		prompt_on_exit_check.setText(StringLocalizer.StringLocalizer("settingswindow.tab.general.checkbox.prompt_on_exit"));
		...
		server_list_update.setText(StringLocalizer.StringLocalizer("settingswindow.tab.general.checkbox.update_server_list"));
		layout_data = new GridData(GridData.FILL_HORIZONTAL);
		layout_data.horizontalSpan = 2;
		...
		startup_update_check.setText(StringLocalizer.StringLocalizer("settingswindow.tab.general.checkbox.startup_update_check"));
		layout_data = new GridData(GridData.FILL_HORIZONTAL);
		layout_data.horizontalSpan = 2;
		...
		connect_at_startup.setText(StringLocalizer.StringLocalizer("settingswindow.tab.general.checkbox.connect_at_startup"));
		layout_data = new GridData(GridData.FILL_HORIZONTAL);
		layout_data.horizontalSpan = 2;
		...
		kad_enabled.setText(StringLocalizer.StringLocalizer("settingswindow.tab.general.checkbox.enable_kad"));
		layout_data = new GridData(GridData.FILL_HORIZONTAL);
		layout_data.horizontalSpan = 2;
		...
		if (JMConstants.IS_NIGHTLY_BUILD) {
			...
			show_nightly_build_warning.setText(StringLocalizer.StringLocalizer("settingswindow.tab.general.checkbox.show_nightly_build_warning"));
			layout_data = new GridData(GridData.FILL_HORIZONTAL);
			layout_data.horizontalSpan = 2;
		...
		ports.setText(StringLocalizer.StringLocalizer("settingswindow.tab.general.group.ports"));
		layout_data = new GridData(GridData.FILL_HORIZONTAL);
		layout_data.horizontalSpan = 2;
		...
		label.setText(StringLocalizer.StringLocalizer("settingswindow.tab.connection.label.tcp_port") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label.setFont(skin.getDefaultFont());
		label.setForeground(skin.getDefaultColor());
		label.setText(StringLocalizer.StringLocalizer("settingswindow.tab.connection.label.udp_port") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		enable_udp.setText(StringLocalizer.StringLocalizer("settingswindow.tab.connection.button.enabled"));
		...
		limits.setText(StringLocalizer.StringLocalizer("settingswindow.tab.general.group.limits"));
		layout_data = new GridData(GridData.FILL_HORIZONTAL);
		layout_data.horizontalSpan = 2;
		...
		label.setFont(skin.getDefaultFont());
		label.setForeground(skin.getDefaultColor());
		label.setText(StringLocalizer.StringLocalizer("settingswindow.tab.connection.label.download_limit") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		new Label(container2,SWT.NONE).setText(StringLocalizer.StringLocalizer("settingswindow.tab.connection.label.kb_s"));
		
		enable_download_limit = new Button(container2,SWT.CHECK);
		enable_download_limit.setText(StringLocalizer.StringLocalizer("settingswindow.tab.connection.button.enabled"));
		...
		label.setFont(skin.getDefaultFont());
		label.setForeground(skin.getDefaultColor());
		label.setText(StringLocalizer.StringLocalizer("settingswindow.tab.connection.label.upload_limit") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		new Label(container3,SWT.NONE).setText(StringLocalizer.StringLocalizer("settingswindow.tab.connection.label.kb_s"));
		
		enable_upload_limit = new Button(container3,SWT.CHECK);
		enable_upload_limit.setText(StringLocalizer.StringLocalizer("settingswindow.tab.connection.button.enabled"));
		...
		capacities.setText(StringLocalizer.StringLocalizer("settingswindow.tab.general.group.capacities"));
		layout_data = new GridData(GridData.FILL_HORIZONTAL);
		layout_data.horizontalSpan = 2;
		...
		label.setFont(skin.getDefaultFont());
		label.setForeground(skin.getDefaultColor());
		label.setText(StringLocalizer.StringLocalizer("settingswindow.tab.connection.label.download_capacity") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label.setFont(skin.getDefaultFont());
		label.setForeground(skin.getDefaultColor());
		label.setText(StringLocalizer.StringLocalizer("settingswindow.tab.connection.label.upload_capacity") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		kbit_button.setText(StringLocalizer.StringLocalizer("settingswindow.tab.connection.button.k_bit"));
		...
		kbyte_button.setText(StringLocalizer.StringLocalizer("settingswindow.tab.connection.button.k_byte"));
	...
	public String getTabName() {
		return StringLocalizer.StringLocalizer("settingswindow.tab.general.name");
	}
