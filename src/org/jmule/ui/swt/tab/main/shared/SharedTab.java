 ...
 */
public class SharedTab extends MainTab {
	...
	public SharedTab(Composite ctab,JMuleCore core) {
		super(ctab,"Shared");
		...
		Composite dir_list = new Composite(tab_content,SWT.NONE);
		Composite shared_files = new Composite(tab_content,SWT.NONE);
		
		SashControl.createHorizontalSash(50, 50, tab_content, dir_list, shared_files);
		...
		if (dir != null)
			dir_list_content.setText(StringLocalizer.StringLocalizer("mainwindow.sharedtab.group.shared_dirs")+"("+dir.size()+")");
		else
			dir_list_content.setText(StringLocalizer.StringLocalizer("mainwindow.sharedtab.group.shared_dirs")+"(0)");
		
		config_listener = new ConfigurationAdapter() {
			public void sharedDirectoriesChanged(java.util.List<File> sharedDirs) {
				dir_list_content.setText(StringLocalizer.StringLocalizer("mainwindow.sharedtab.group.shared_dirs")+"("+sharedDirs.size()+")");
			}
		};
		...
		add_button.setText(StringLocalizer.StringLocalizer("mainwindow.sharedtab.button.add"));
		...
		add_button.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent event) {
				DirectoryDialog dir_dialog = new DirectoryDialog (tab_content.getShell(),SWT.MULTI | SWT.OPEN);
		...
		remove_button.setText(StringLocalizer.StringLocalizer("mainwindow.sharedtab.button.remove"));
		...
		clear_button.setText(StringLocalizer.StringLocalizer("mainwindow.sharedtab.button.clear"));
		...
		reload_button.setText(StringLocalizer.StringLocalizer("mainwindow.sharedtab.button.reload"));
		...
		shared_files_group.setText(StringLocalizer.StringLocalizer("mainwindow.sharedtab.group.shared_files"));
		...
		shared_files_table = new JMTable<SharedFile>(shared_files_group, SWT.NONE){
			...
			public void updateRow(SharedFile object) {
				...
				if (status == HASHED) {
					...
					if (status == HASHING)
						setRowText(object,SWTConstants.SHARED_LIST_FILE_ID_COLUMN_ID, StringLocalizer.StringLocalizer("mainwindow.sharedtab.label.hashing"));
					else
						setRowText(object,SWTConstants.SHARED_LIST_FILE_ID_COLUMN_ID, StringLocalizer.StringLocalizer("mainwindow.sharedtab.label.waiting_to_hash"));
			}
	  ...
	  shared_files_table.addColumn(SWT.LEFT,  SWTConstants.SHARED_LIST_FILE_NAME_COLUMN_ID, StringLocalizer.StringLocalizer("mainwindow.sharedtab.column.filename"), "", width);
	  
	  width = SWTPreferences.getInstance().getColumnWidth(SWTConstants.SHARED_LIST_FILE_SIZE_COLUMN_ID);
	  shared_files_table.addColumn(SWT.RIGHT, SWTConstants.SHARED_LIST_FILE_SIZE_COLUMN_ID, StringLocalizer.StringLocalizer("mainwindow.sharedtab.column.filesize"), "", width);
	  
	  width = SWTPreferences.getInstance().getColumnWidth(SWTConstants.SHARED_LIST_FILE_TYPE_COLUMN_ID);
	  shared_files_table.addColumn(SWT.LEFT,  SWTConstants.SHARED_LIST_FILE_TYPE_COLUMN_ID, StringLocalizer.StringLocalizer("mainwindow.sharedtab.column.filetype"), "",width);
	  
	  width = SWTPreferences.getInstance().getColumnWidth(SWTConstants.SHARED_LIST_FILE_ID_COLUMN_ID);
	  shared_files_table.addColumn(SWT.LEFT,  SWTConstants.SHARED_LIST_FILE_ID_COLUMN_ID,   StringLocalizer.StringLocalizer("mainwindow.sharedtab.column.fileid"), "", width);
	  
	  width = SWTPreferences.getInstance().getColumnWidth(SWTConstants.SHARED_LIST_COMPLETED_COLUMN_ID);
	  shared_files_table.addColumn(SWT.RIGHT,  SWTConstants.SHARED_LIST_COMPLETED_COLUMN_ID, StringLocalizer.StringLocalizer("mainwindow.sharedtab.column.completed"), "", width);
	  ...
	  column_setup_menu_item.setText(StringLocalizer.StringLocalizer("mainwindow.sharedtab.popupmenu.column_setup"));
	  ...
	  open_selected_menu_item.setText(StringLocalizer.StringLocalizer("mainwindow.sharedtab.popupmenu.open"));
	  ...
	  copy_ed2k_link_menu_item.setText(StringLocalizer.StringLocalizer("mainwindow.sharedtab.popupmenu.copy_ed2k_link"));
	  ...
	  remove_from_disk_menu_item.setText(StringLocalizer.StringLocalizer("mainwindow.sharedtab.popupmenu.remove_from_disk"));
	  ...
	  selected_column_setup_menu_item.setText(StringLocalizer.StringLocalizer("mainwindow.sharedtab.popupmenu.column_setup"));
	  ...
	  rating_menu_item.setText(StringLocalizer.StringLocalizer("mainwindow.searchtab.popupmenu.rating_submenu"));
	  ...
	  file_not_rated.setText(StringLocalizer.StringLocalizer("mainwindow.searchtab.popupmenu.rating_submenu.not_rated"));
	  ...
	  file_fake.setText(StringLocalizer.StringLocalizer("mainwindow.searchtab.popupmenu.rating_submenu.fake"));
	  ...
	  file_poor.setText(StringLocalizer.StringLocalizer("mainwindow.searchtab.popupmenu.rating_submenu.poor"));
	  ...
	  file_fair.setText(StringLocalizer.StringLocalizer("mainwindow.searchtab.popupmenu.rating_submenu.fair"));
	  ...
	  file_good.setText(StringLocalizer.StringLocalizer("mainwindow.searchtab.popupmenu.rating_submenu.good"));
	  ...
	  file_excellent.setText(StringLocalizer.StringLocalizer("mainwindow.searchtab.popupmenu.rating_submenu.excellent"));
	  ...
	  properties_menu_item.setText(StringLocalizer.StringLocalizer("mainwindow.sharedtab.popupmenu.properties"));
	...
	refreshable = new Refreshable() {
		public void refresh() {
			...
			String text = StringLocalizer.StringLocalizer("mainwindow.sharedtab.group.shared_files");
			SharedFile hashing_file = sharing_manager.getCurrentHashingFile();
			if (hashing_file != null) {
				text +=" Hashing [";
	...
	private void removeSelectedDir() {
		if (!Utils.showConfirmMessage(tab_content.getShell(), StringLocalizer.StringLocalizer("mainwindow.sharedtab.confirm_remove_shared_dir_title"),
				 StringLocalizer.StringLocalizer("mainwindow.sharedtab.confirm_remove_shared_dir"))) return ;
	...
	private void clearDirList() {
		if (!Utils.showConfirmMessage(tab_content.getShell(), StringLocalizer.StringLocalizer("mainwindow.sharedtab.confirm_clear_dir_list_title"),
				 StringLocalizer.StringLocalizer("mainwindow.sharedtab.confirm_clear_dir_list"))) return ;
	...
	private void removeFromDisk() {
		if (!Utils.showConfirmMessage(tab_content.getShell(), StringLocalizer.StringLocalizer("mainwindow.sharedtab.confirm_remove_from_disk_title"),
									 StringLocalizer.StringLocalizer("mainwindow.sharedtab.confirm_remove_from_disk"))) return ;
	...
	private void updateDirList(final java.util.List<File> directoryList) {
		SWTThread.getDisplay().asyncExec(new JMRunnable() {
			public void JMRun() {
				...
				shared_dir_list.add(StringLocalizer.StringLocalizer("mainwindow.sharedtab.shared_dirs.incoming"));
				shared_dir_list.add(StringLocalizer.StringLocalizer("mainwindow.sharedtab.shared_dirs.partial"));
				shared_dir_list.add(StringLocalizer.StringLocalizer("mainwindow.sharedtab.shared_dirs.all"));
	...
	private void updateFileList(final String dir) {
		...
		file_list_updater = new JMThread() {
			...
			public void run() {
				...
				if (dir.equals(StringLocalizer.StringLocalizer("mainwindow.sharedtab.shared_dirs.partial"))) {
				...
				if (dir.equals(StringLocalizer.StringLocalizer("mainwindow.sharedtab.shared_dirs.incoming")))
					shared_dir = new File(ConfigurationManager.INCOMING_DIR);	
					
				if (!dir.equals(StringLocalizer.StringLocalizer("mainwindow.sharedtab.shared_dirs.all"))) {
