...
public class SharedFilePropertiesWindow implements JMuleUIComponent {
	...
	public void getCoreComponents() {
		...
		shell.setText(StringLocalizer.StringLocalizer("sharedfilepropertieswindow.title"));
		...
		label.setText(StringLocalizer.StringLocalizer("sharedfilepropertieswindow.label.filename")+" : ");
		...
		label = new Label(shared_file_fields,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(StringLocalizer.StringLocalizer("sharedfilepropertieswindow.label.filesize")+" : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		label = new Label(shared_file_fields,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setLayoutData(new GridData(GridData.FILL_HORIZONTAL));
		...
		label = new Label(shared_file_fields,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(StringLocalizer.StringLocalizer("sharedfilepropertieswindow.label.filepath")+" : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		label = new Label(shared_file_fields,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setLayoutData(new GridData(GridData.FILL_HORIZONTAL));
		...
		label = new Label(shared_file_fields,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(StringLocalizer.StringLocalizer("sharedfilepropertieswindow.label.filestype")+" : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		label = new Label(shared_file_fields,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setLayoutData(new GridData(GridData.FILL_HORIZONTAL));
		...
		label = new Label(shared_file_fields,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(StringLocalizer.StringLocalizer("sharedfilepropertieswindow.label.file_hash")+" : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		label = new Label(shared_file_fields,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setLayoutData(new GridData(GridData.FILL_HORIZONTAL));
		...
		label = new Label(shared_file_fields,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(StringLocalizer.StringLocalizer("sharedfilepropertieswindow.label.completed")+" : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(shared_file_fields,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.get("sharedfilepropertieswindow.label.ed2k_link") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label.setToolTipText(StringLocalizer.StringLocalizer("sharedfilepropertieswindow.label.ed2k_link.tooltip"));
		label.setForeground(SWTThread.getDisplay().getSystemColor(SWT.COLOR_BLUE));
		...
		label = new Label(shared_file_fields,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(StringLocalizer.StringLocalizer("sharedfilepropertieswindow.label.file_quality") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		file_quality_combo.add(StringLocalizer.StringLocalizer("sharedfilepropertieswindow.label.fq_not_rated"));
		file_quality_combo.setData(StringLocalizer.StringLocalizer("sharedfilepropertieswindow.label.fq_not_rated"), FileQuality.NOTRATED);
		
		file_quality_combo.add(StringLocalizer.StringLocalizer("sharedfilepropertieswindow.label.fq_fake"));
		file_quality_combo.setData(StringLocalizer.StringLocalizer("sharedfilepropertieswindow.label.fq_fake"), FileQuality.FAKE);
		
		file_quality_combo.add(StringLocalizer.StringLocalizer("sharedfilepropertieswindow.label.fq_poor"));
		file_quality_combo.setData(StringLocalizer.StringLocalizer("sharedfilepropertieswindow.label.fq_poor"), FileQuality.POOR);
		
		file_quality_combo.add(StringLocalizer.StringLocalizer("sharedfilepropertieswindow.label.fq_fair"));
		file_quality_combo.setData(StringLocalizer.StringLocalizer("sharedfilepropertieswindow.label.fq_fair"), FileQuality.FAIR);
		
		file_quality_combo.add(StringLocalizer.StringLocalizer("sharedfilepropertieswindow.label.fq_good"));
		file_quality_combo.setData(StringLocalizer.StringLocalizer("sharedfilepropertieswindow.label.fq_good"), FileQuality.GOOD);
		
		file_quality_combo.add(StringLocalizer.StringLocalizer("sharedfilepropertieswindow.label.fq_excellent"));
		file_quality_combo.setData(StringLocalizer.StringLocalizer("sharedfilepropertieswindow.label.fq_excellent"), FileQuality.EXCELLENT);
		...
		button_ok.setText(StringLocalizer.StringLocalizer("sharedfilepropertieswindow.button.ok"));
		...
		button_cancel.setText(StringLocalizer.StringLocalizer("sharedfilepropertieswindow.button.cancel"));
