...
public class AlreadyExistDirsWindow implements JMuleUIComponent {
	...
	public void initUIComponents() {
		...
		shell.setText(StringLocalizer.StringLocalizer("alreadyexistdirswindow.title"));
		
		shell.setLayout(new GridLayout(1,false));
		
		Label info = new Label(shell,SWT.NONE);
		info.setFont(skin.getLabelFont());
		info.setText(StringLocalizer.StringLocalizer("alreadyexistdirswindow.label.info"));
		...
		button_ok.setText(StringLocalizer.StringLocalizer("alreadyexistdirswindow.button.ok"));
