...
public class ConnectionInfo extends CTabFolder implements Refreshable {
	...
	public ConnectionInfo(Composite parent,JMuleCore core) {
		...
		my_info.setText(Localizer.get("mainwindow.serverlisttab.connectioninfo.myinfo"));
		
		server_info = new CTabItem(this, SWT.NONE);
		server_info.setText(Localizer.get("mainwindow.serverlisttab.connectioninfo.serverinfo"));
		...
		label.setText(Localizer.get("mainwindow.serverlisttab.connectioninfo.myinfo.status")+" : ");
		...
		label = new Label(my_info_content,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.get("mainwindow.serverlisttab.connectioninfo.myinfo.id")+ " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(my_info_content,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.get("mainwindow.serverlisttab.connectioninfo.myinfo.ip") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(my_info_content,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.get("mainwindow.serverlisttab.connectioninfo.myinfo.nickname") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(my_info_content,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.get("mainwindow.serverlisttab.connectioninfo.myinfo.sharedfiles") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.get("mainwindow.serverlisttab.connectioninfo.serverinfo.address")+" : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(server_info_content,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.get("mainwindow.serverlisttab.connectioninfo.serverinfo.name") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(server_info_content,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.get("mainwindow.serverlisttab.connectioninfo.serverinfo.desc") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(server_info_content,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.get("mainwindow.serverlisttab.connectioninfo.serverinfo.users") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(server_info_content,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.get("mainwindow.serverlisttab.connectioninfo.serverinfo.files") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(server_info_content,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.get("mainwindow.serverlisttab.connectioninfo.serverinfo.ping") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(server_info_content,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.get("mainwindow.serverlisttab.connectioninfo.serverinfo.hardlimit") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(server_info_content,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.get("mainwindow.serverlisttab.connectioninfo.serverinfo.softlimit") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(server_info_content,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.get("mainwindow.serverlisttab.connectioninfo.serverinfo.version") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
	...
	public void setStatusDisconnected() {
		my_info_status.setText(Localizer.get("mainwindow.serverlisttab.connectioninfo.myinfo.disconnected"));
	...
	public void setStatusConnecting(Server server) {
		my_info_status.setText(Localizer.get("mainwindow.serverlisttab.connectioninfo.myinfo.connecting"));
        my_info_client_id.setText("");
        my_info_client_id.setToolTipText("");
        my_info_user_ip.setText("");
	...
	public void setStatusConnected( Server server) {
		my_info_status.setText(Localizer.get("mainwindow.serverlisttab.connectioninfo.myinfo.connected"));
		long client_id = Convert.intToLong(server.getClientID().hashCode());
        my_info_client_id.setText(client_id + " " + (server.getClientID().isHighID() ? Localizer.get("mainwindow.serverlisttab.connectioninfo.myinfo.high_id") : Localizer.get("mainwindow.serverlisttab.connectioninfo.myinfo.low_id") ));
        my_info_client_id.setToolTipText("");
