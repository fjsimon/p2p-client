...
public class ServerMessages extends Text {
	...
	public ServerMessages(Composite composite) {
		...
		copy_selected.setText(StringLocalizer.StringLocalizer("mainwindow.serverlisttab.servermesasges.popupmenu.copy"));
		...
		select_all.setText(StringLocalizer.StringLocalizer("mainwindow.serverlisttab.servermesasges.popupmenu.select_all"));
		...
		clear.setText(StringLocalizer.StringLocalizer("mainwindow.serverlisttab.servermesasges.popupmenu.clear"));
