...
public class ServerAddWindow implements JMuleUIComponent {
	...
	public void initUIComponents() {
		String title = Localizer.get("serveraddwindow.title");
		SWTSkin skin = null;
		try {
		...
		label.setText(Localizer.get("serveraddwindow.server_ip_address")+" : ");
		...
		label.setFont(skin.getLabelFont());
		label.setText(Localizer.get("serveraddwindow.server_port")+" : ");
		...
		button_ok.setText(Localizer.get("mainwindow.button.ok"));
		...
		public void widgetDefaultSelected(SelectionEvent arg0) {
			...
			public void widgetSelected(SelectionEvent arg0) {
				...
				if (!AddressUtils.isValidIP(server_ip)) {
					...
					dialog.setMessage(Localizer.get("serveraddwindow.wrong_server_address"));
					dialog.open();
					return ;
				}
				...
				if (!AddressUtils.isValidPort(text_port.getText())) {
					MessageBox dialog = new MessageBox(shell,
					SWT.OK | SWT.ICON_WARNING);
					dialog.setMessage(Localizer.get("serveraddwindow.wrong_server_port"));
					dialog.open();
					return ;
				}
		...
		button_cancel.setText(Localizer.get("mainwindow.button.cancel"));
