...
public class DownloadPeerListTab extends CTabItem implements Refreshable {
	...
	public DownloadPeerListTab(CTabFolder tabFolder, DownloadSession downloadSession) {
		...
		setText(StringLocalizer.StringLocalizer("downloadinfowindow.tab.peerlist.title"));
		...
		column_setup.setText(StringLocalizer.StringLocalizer("downloadinfowindow.tab.peerlist.menu.column_setup"));
	...
	private class DownloadPeerList extends JMTable<Peer>{		
		...
		public DownloadPeerList(Composite content) {
			...
			addColumn(SWT.LEFT, SWTConstants.DOWNLOAD_PEER_LIST_NICKNAME_COLUMN_ID,   StringLocalizer.StringLocalizer("downloadinfowindow.tab.peerlist.column.nickname"), "", width);
			
			width = swt_preferences.getColumnWidth(SWTConstants.DOWNLOAD_PEER_LIST_CC_COLUMN_ID);
			addColumn(SWT.CENTER,SWTConstants.DOWNLOAD_PEER_LIST_CC_COLUMN_ID, StringLocalizer.StringLocalizer("downloadinfowindow.tab.peerlist.column.country_code"), StringLocalizer.StringLocalizer("downloadinfowindow.tab.peerlist.column.country_code.desc"), width);
			...
			addColumn(SWT.LEFT, SWTConstants.DOWNLOAD_PEER_LIST_FLAG_COLUMN_ID, 	  	StringLocalizer.StringLocalizer("downloadinfowindow.tab.peerlist.column.flag"), "", width);
			if (CountryLocator.getInstance().isServiceDown())
			...
			addColumn(SWT.LEFT, SWTConstants.DOWNLOAD_PEER_LIST_IP_COLUMN_ID, 	  	 StringLocalizer.StringLocalizer("downloadinfowindow.tab.peerlist.column.address"), "", width);
			
			width = swt_preferences.getColumnWidth(SWTConstants.DOWNLOAD_PEER_LIST_SOURCE_COLUMN_ID);
			addColumn(SWT.LEFT, SWTConstants.DOWNLOAD_PEER_LIST_SOURCE_COLUMN_ID, 	  	 StringLocalizer.StringLocalizer("downloadinfowindow.tab.peerlist.column.source"),  StringLocalizer.StringLocalizer("downloadinfowindow.tab.peerlist.column.source.desc"), width);
			
			width = swt_preferences.getColumnWidth(SWTConstants.DOWNLOAD_PEER_LIST_DOWN_SPEED_COLUMN_ID); 
			addColumn(SWT.RIGHT, SWTConstants.DOWNLOAD_PEER_LIST_DOWN_SPEED_COLUMN_ID, StringLocalizer.StringLocalizer("downloadinfowindow.tab.peerlist.column.download_speed"), "", width);
			
			width = swt_preferences.getColumnWidth(SWTConstants.DOWNLOAD_PEER_LIST_UP_SPEED_COLUMN_ID);
			addColumn(SWT.RIGHT, SWTConstants.DOWNLOAD_PEER_LIST_UP_SPEED_COLUMN_ID,   StringLocalizer.StringLocalizer("downloadinfowindow.tab.peerlist.column.upload_speed"),  "", width);
			
			width = swt_preferences.getColumnWidth(SWTConstants.DOWNLOAD_PEER_LIST_SOFTWARE_COLUMN_ID); 
			addColumn(SWT.LEFT, SWTConstants.DOWNLOAD_PEER_LIST_SOFTWARE_COLUMN_ID,   StringLocalizer.StringLocalizer("downloadinfowindow.tab.peerlist.column.software"), "", width);
			
			width = swt_preferences.getColumnWidth(SWTConstants.DOWNLOAD_PEER_LIST_STATUS_COLUMN_ID);
			addColumn(SWT.LEFT, SWTConstants.DOWNLOAD_PEER_LIST_STATUS_COLUMN_ID,     StringLocalizer.StringLocalizer("downloadinfowindow.tab.peerlist.column.status"), "", width);
		...
		public void updateRow(Peer object) {
			...
			if (download_session.hasPeer(object)) {
				...
				if (rank!=0) {
					...
					str = StringLocalizer.StringLocalizer("downloadinfowindow.tab.peerlist.column.status.uploading");
				}
