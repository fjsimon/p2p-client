...
public class DownloadList extends JMTable<DownloadSession> implements Refreshable,DownloadManagerListener {
	...
	public DownloadList(Composite composite, JMuleCore core) {
		...
		addColumn(SWT.LEFT, SWTConstants.DOWNLOAD_LIST_FILE_NAME_COLUMN_ID, StringLocalizer.StringLocalizer("mainwindow.transferstab.downloads.column.filename"),"", width);
		
		width = swt_preferences.getColumnWidth(SWTConstants.DOWNLOAD_LIST_SIZE_COLUMN_ID);
		addColumn(SWT.RIGHT, SWTConstants.DOWNLOAD_LIST_SIZE_COLUMN_ID, 	StringLocalizer.StringLocalizer("mainwindow.transferstab.downloads.column.size"),"", width);
		
		width = swt_preferences.getColumnWidth(SWTConstants.DOWNLOAD_LIST_TRANSFERRED_COLUMN_ID);
		addColumn(SWT.RIGHT, SWTConstants.DOWNLOAD_LIST_TRANSFERRED_COLUMN_ID, StringLocalizer.StringLocalizer("mainwindow.transferstab.downloads.column.transferred"),"", width);
		
		width = swt_preferences.getColumnWidth(SWTConstants.DOWNLOAD_LIST_DOWNLOAD_SPEED_COLUMN_ID);
		addColumn(SWT.RIGHT, SWTConstants.DOWNLOAD_LIST_DOWNLOAD_SPEED_COLUMN_ID, StringLocalizer.StringLocalizer("mainwindow.transferstab.downloads.column.download_speed"), "", width);
		
		width = swt_preferences.getColumnWidth(SWTConstants.DOWNLOAD_LIST_UPLOAD_SPEED_COLUMN_ID);
		addColumn(SWT.RIGHT, SWTConstants.DOWNLOAD_LIST_UPLOAD_SPEED_COLUMN_ID, StringLocalizer.StringLocalizer("mainwindow.transferstab.downloads.column.upload_speed"),"", width);
		
		width = swt_preferences.getColumnWidth(SWTConstants.DOWNLOAD_LIST_PROGRESS_COLUMN_ID);
		addColumn(SWT.LEFT, SWTConstants.DOWNLOAD_LIST_PROGRESS_COLUMN_ID, StringLocalizer.StringLocalizer("mainwindow.transferstab.downloads.column.progress"),"", width);

		width = swt_preferences.getColumnWidth(SWTConstants.DOWNLOAD_LIST_COMPLETED_COLUMN_ID);
		addColumn(SWT.RIGHT, SWTConstants.DOWNLOAD_LIST_COMPLETED_COLUMN_ID, StringLocalizer.StringLocalizer("mainwindow.transferstab.downloads.column.completed"),"", width);
		
		width = swt_preferences.getColumnWidth(SWTConstants.DOWNLOAD_LIST_SOURCES_COLUMN_ID);
		addColumn(SWT.RIGHT, SWTConstants.DOWNLOAD_LIST_SOURCES_COLUMN_ID, StringLocalizer.StringLocalizer("mainwindow.transferstab.downloads.column.sources"),"", width);
		
		width = swt_preferences.getColumnWidth(SWTConstants.DOWNLOAD_LIST_REMAINING_COLUMN_ID);
		addColumn(SWT.RIGHT, SWTConstants.DOWNLOAD_LIST_REMAINING_COLUMN_ID, StringLocalizer.StringLocalizer("mainwindow.transferstab.downloads.column.eta"), StringLocalizer.StringLocalizer("mainwindow.transferstab.downloads.column.eta.desc"), width);
		
		width = swt_preferences.getColumnWidth(SWTConstants.DOWNLOAD_LIST_STATUS_COLUMN_ID);
		addColumn(SWT.LEFT, SWTConstants.DOWNLOAD_LIST_STATUS_COLUMN_ID, StringLocalizer.StringLocalizer("mainwindow.transferstab.downloads.column.status"),"", width);
		
		width = swt_preferences.getColumnWidth(SWTConstants.DOWNLOAD_LIST_COMPLETE_SOURCES_COLUMN_ID);
		addColumn(SWT.RIGHT, SWTConstants.DOWNLOAD_LIST_COMPLETE_SOURCES_COLUMN_ID, StringLocalizer.StringLocalizer("mainwindow.transferstab.downloads.column.completed_src"), "", width);
		
		width = swt_preferences.getColumnWidth(SWTConstants.DOWNLOAD_LIST_PARTIAL_SOURCES_COLUMN_ID);
		addColumn(SWT.RIGHT, SWTConstants.DOWNLOAD_LIST_PARTIAL_SOURCES_COLUMN_ID, StringLocalizer.StringLocalizer("mainwindow.transferstab.downloads.column.partial_src"), "", width);
		...
		paste_ed2k_file_links.setText(StringLocalizer.StringLocalizer("mainwindow.transferstab.downloads.popupmenu.paste_ed2k_links"));
		...
		column_setup.setText(StringLocalizer.StringLocalizer("mainwindow.transferstab.downloads.popupmenu.column_setup"));
		...
		set_download_status.setText(StringLocalizer.StringLocalizer("mainwindow.transferstab.downloads.popupmenu.start_download"));
		...
		single_cancel_download.setText(StringLocalizer.StringLocalizer("mainwindow.transferstab.downloads.popupmenu.cancel_download"));
		...
		copy_ed2k_link.setText(StringLocalizer.StringLocalizer("mainwindow.transferstab.downloads.popupmenu.copy_ed2k_link"));
		...
		paste_ed2k_link.setText(StringLocalizer.StringLocalizer("mainwindow.transferstab.downloads.popupmenu.paste_ed2k_link"));
		...
		download_details.setText(StringLocalizer.StringLocalizer("mainwindow.transferstab.downloads.popupmenu.details"));
		...
		multiple_start_download.setText(StringLocalizer.StringLocalizer("mainwindow.transferstab.downloads.popupmenu.start_downloads"));
		...
		multiple_stop_download.setText(StringLocalizer.StringLocalizer("mainwindow.transferstab.downloads.popupmenu.stop_downloads"));
		...
		multiple_cancel_download.setText(StringLocalizer.StringLocalizer("mainwindow.transferstab.downloads.popupmenu.cancel_downloads"));
		...
		multiple_copy_ed2k_links.setText(StringLocalizer.StringLocalizer("mainwindow.transferstab.downloads.popupmenu.copy_ed2k_links"));
	...
	protected Menu getPopUpMenu() {
		...
		case STARTED_DOWNLOAD_SELECTED : {
			...
			set_download_status.setText(StringLocalizer.StringLocalizer("mainwindow.transferstab.downloads.popupmenu.stop_download"));
	...
	public void updateRow(DownloadSession session) {
		...
		if (session.getStatus() == DownloadStatus.STARTED)
			status = StringLocalizer.StringLocalizer("mainwindow.transferstab.downloads.column.status.started");
		else
			status = StringLocalizer.StringLocalizer("mainwindow.transferstab.downloads.column.status.stopped");
	...
	public void cancelSelectedDownloads() {
		...
		List<DownloadSession> list = getSelectedObjects();
		if (list.size()==1)
			result = Utils.showConfirmMessage(getShell(), StringLocalizer.StringLocalizer("mainwindow.transferstab.downloads.confirm_cancel.title"), StringLocalizer.StringLocalizer("mainwindow.transferstab.downloads.confirm_cancel"));
		else
			result = Utils.showConfirmMessage(getShell(), StringLocalizer.StringLocalizer("mainwindow.transferstab.downloads.confirm_cancel.title") , StringLocalizer.StringLocalizer("mainwindow.transferstab.downloads.confirm_cancel_multi"));
		if (result)
			for(DownloadSession downloadSession : list)
				try {
	...
	private void pasteED2KLink() {
		...
		if (failed.length()!=0)
			Utils.showWarningMessage(getShell(), StringLocalizer.StringLocalizer("mainwindow.transferstab.downloads.ed2k_paste_failed_already_exist.title"), StringLocalizer.StringLocalizer("mainwindow.transferstab.downloads.ed2k_paste_failed_already_exist")+" : \n"+failed + "\n\n"+ StringLocalizer.StringLocalizer("mainwindow.transferstab.downloads.ed2k_paste_failed_already_exist2"));
		...
		SWTThread.getDisplay().asyncExec(new JMRunnable() {
			public void JMRun() {
				...
				try {
					...
					addDownlaodSession(session);
					MainWindow.getLogger().fine(StringLocalizer.StringLocalizer("mainwindow.logtab.message_download_added",session.getSharingName()));
				} catch (DownloadManagerException e) {
					e.printStackTrace();
				}
		...
		SWTThread.getDisplay().asyncExec(new JMRunnable() {
			public void JMRun() {
				...
				if (session.getPercentCompleted()!=100)
					MainWindow.getLogger().fine(StringLocalizer.StringLocalizer("mainwindow.logtab.message_download_removed",session.getSharingName()));
				else
					MainWindow.getLogger().fine(StringLocalizer.StringLocalizer("mainwindow.logtab.message_download_finished",session.getSharingName()));
			}
		});
	}
	...
	public void downloadStarted(final FileHash fileHash) {
		SWTThread.getDisplay().asyncExec(new JMRunnable() {
			public void JMRun() {
				...
				MainWindow.getLogger().fine(StringLocalizer.StringLocalizer("mainwindow.logtab.message_download_started",downloadSession.getSharingName()));
		}});
	...
	public void downloadStopped(final FileHash fileHash) {
		SWTThread.getDisplay().asyncExec(new JMRunnable() {
			public void JMRun() {
				...
				updateRow(downloadSession);
				MainWindow.getLogger().fine(StringLocalizer.StringLocalizer("mainwindow.logtab.message_download_stopped",downloadSession.getSharingName()));
		}});
	}
