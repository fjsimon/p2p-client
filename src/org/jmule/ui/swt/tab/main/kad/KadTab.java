...
public class KadTab extends MainTab {
	...
	public KadTab(Composite ctab, JMuleCore core) {		
		...
		contact_list.addColumn(SWT.LEFT, KAD_CLIENT_ID_COLUMN_ID, StringLocalizer.StringLocalizer("mainwindow.kadtab.contact_list.column.contact_id"), StringLocalizer.StringLocalizer("mainwindow.kadtab.contact_list.column.contact_id.desc"), swt_preferences.getColumnWidth(KAD_CLIENT_ID_COLUMN_ID));
		contact_list.addColumn(SWT.LEFT, KAD_CLIENT_DISTANCE_COLUMN_ID, StringLocalizer.StringLocalizer("mainwindow.kadtab.contact_list.column.contact_distance"), StringLocalizer.StringLocalizer("mainwindow.kadtab.contact_list.column.contact_distance.desc"), swt_preferences.getColumnWidth(KAD_CLIENT_DISTANCE_COLUMN_ID));
		...
		kad_task_list.addColumn(SWT.LEFT, KAD_TASK_TYPE_COLUMN_ID, StringLocalizer.StringLocalizer("mainwindow.kadtab.task_list.column.task_type"), StringLocalizer.StringLocalizer("mainwindow.kadtab.task_list.column.task_type.desc"), swt_preferences.getColumnWidth(KAD_TASK_TYPE_COLUMN_ID));
		kad_task_list.addColumn(SWT.LEFT, KAD_TASK_LOOKUP_HASH_COLUMN_ID, StringLocalizer.StringLocalizer("mainwindow.kadtab.task_list.column.task_hash"), StringLocalizer.StringLocalizer("mainwindow.kadtab.task_list.column.task_hash.desc"), swt_preferences.getColumnWidth(KAD_TASK_LOOKUP_HASH_COLUMN_ID));
		kad_task_list.addColumn(SWT.LEFT, KAD_TASK_LOOKUP_INFO_COLUMN_ID, StringLocalizer.StringLocalizer("mainwindow.kadtab.task_list.column.task_info"), StringLocalizer.StringLocalizer("mainwindow.kadtab.task_list.column.task_info.desc"), swt_preferences.getColumnWidth(KAD_TASK_LOOKUP_INFO_COLUMN_ID));
