...
public class SearchPropertiesWindow implements JMuleUIComponent {
	...
	public SearchPropertiesWindow(SearchResultItem item) {
		...
		shell.setText(StringLocalizer.StringLocalizer("searchpropertieswindow.title"));
		...
		label.setText(StringLocalizer.StringLocalizer("searchpropertieswindow.label.filename")+" : ");
		...
		label = new Label(search_fields,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(StringLocalizer.StringLocalizer("searchpropertieswindow.label.filesize")+" : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(search_fields,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(StringLocalizer.StringLocalizer("searchpropertieswindow.label.availability")+" : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(search_fields,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(StringLocalizer.StringLocalizer("searchpropertieswindow.label.completesrc")+" : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(search_fields,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(StringLocalizer.StringLocalizer("searchpropertieswindow.label.type")+" : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(search_fields,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(StringLocalizer.StringLocalizer("searchpropertieswindow.label.filehash")+" : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label.setToolTipText(StringLocalizer.StringLocalizer("searchpropertieswindow.label.ed2k_link.tooltip"));
		...
		label = new Label(search_fields,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(StringLocalizer.StringLocalizer("searchpropertieswindow.label.filequality") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		switch(search_result.getFileQuality()) {
			case FAKE : label.setText(StringLocalizer.StringLocalizer("searchpropertieswindow.label.fq_fake")); break;
			case POOR : label.setText(StringLocalizer.StringLocalizer("searchpropertieswindow.label.fq_poor")); break;
			case FAIR : label.setText(StringLocalizer.StringLocalizer("searchpropertieswindow.label.fq_fair")); break;
			case GOOD : label.setText(StringLocalizer.StringLocalizer("searchpropertieswindow.label.fq_good")); break;
			case EXCELLENT : label.setText(StringLocalizer.StringLocalizer("searchpropertieswindow.label.fq_excellent")); break;
			default : label.setText(StringLocalizer.StringLocalizer("searchpropertieswindow.label.fq_not_rated")); break;
		}
		...
		button.setText(StringLocalizer.StringLocalizer("searchpropertieswindow.button.close"));
