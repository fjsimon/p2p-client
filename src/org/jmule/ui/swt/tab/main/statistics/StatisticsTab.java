...
public class StatisticsTab extends MainTab {
	...
	public StatisticsTab(Composite content) {
		...
		network_stats.setText(StringLocalizer.StringLocalizer("mainwindow.statisticstab.tab.general"));
		...
		sessions_stats.setText(StringLocalizer.StringLocalizer("mainwindow.statisticstab.tab.general.group.sessions"));
		...
		label.setText(StringLocalizer.StringLocalizer("mainwindow.statisticstab.tab.general.label.session_downloaded") + " : ");
		...
		label = new Label(sessions_stats,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(StringLocalizer.StringLocalizer("mainwindow.statisticstab.tab.general.label.session_uploaded") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(sessions_stats,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(StringLocalizer.StringLocalizer("mainwindow.statisticstab.tab.general.label.session_download_count") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(sessions_stats,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(StringLocalizer.StringLocalizer("mainwindow.statisticstab.tab.general.label.session_upload_count") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		peers_stats.setText(StringLocalizer.StringLocalizer("mainwindow.statisticstab.tab.general.group.peers"));
		...
		label.setFont(skin.getLabelFont());
		label.setText(StringLocalizer.StringLocalizer("mainwindow.statisticstab.tab.general.label.peer_count") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(peers_stats,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(StringLocalizer.StringLocalizer("mainwindow.statisticstab.tab.general.label.download_peers") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(peers_stats,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(StringLocalizer.StringLocalizer("mainwindow.statisticstab.tab.general.label.upload_peers") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		sesvers_stats.setText(StringLocalizer.StringLocalizer("mainwindow.statisticstab.tab.general.group.servers"));
		layout_data = new GridData(GridData.FILL_HORIZONTAL | GridData.VERTICAL_ALIGN_BEGINNING );
		...
		label.setFont(skin.getLabelFont());
		label.setText(StringLocalizer.StringLocalizer("mainwindow.statisticstab.tab.general.label.server_count") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(sesvers_stats,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(StringLocalizer.StringLocalizer("mainwindow.statisticstab.tab.general.label.server_alive_count") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(sesvers_stats,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(StringLocalizer.StringLocalizer("mainwindow.statisticstab.tab.general.label.server_dead_count") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(sesvers_stats,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(StringLocalizer.StringLocalizer("mainwindow.statisticstab.tab.general.label.search_query_count") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		sharing_stats.setText(StringLocalizer.StringLocalizer("mainwindow.statisticstab.tab.general.group.shared"));
		label = new Label(sharing_stats,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(StringLocalizer.StringLocalizer("mainwindow.statisticstab.tab.general.label.shared_files_count") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(sharing_stats,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(StringLocalizer.StringLocalizer("mainwindow.statisticstab.tab.general.label.shared_partial_files") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(sharing_stats,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(StringLocalizer.StringLocalizer("mainwindow.statisticstab.tab.general.label.shared_completed_files") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(sharing_stats,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(StringLocalizer.StringLocalizer("mainwindow.statisticstab.tab.general.label.shared_files_bytes") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(sharing_stats,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(StringLocalizer.StringLocalizer("mainwindow.statisticstab.tab.general.label.completed_files_bytes") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(sharing_stats,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(StringLocalizer.StringLocalizer("mainwindow.statisticstab.tab.general.label.partial_files_bytes") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		jvm_stats.setText(StringLocalizer.StringLocalizer("mainwindow.statisticstab.tab.jvm"));
		content = new Composite(stats_tabs,SWT.NONE);
		jvm_stats.setControl(content);
		content.setLayout(new GridLayout(2,true));
		
		Group jvm_general_stats = new Group(content,SWT.NONE);
		jvm_general_stats.setText(StringLocalizer.StringLocalizer("mainwindow.statisticstab.tab.jvm.group.general"));
		layout_data = new GridData(GridData.FILL_HORIZONTAL);
		...
		label.setFont(skin.getLabelFont());
		label.setText(StringLocalizer.StringLocalizer("mainwindow.statisticstab.tab.jvm.label.jvm_name") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(jvm_general_stats,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(StringLocalizer.StringLocalizer("mainwindow.statisticstab.tab.jvm.label.jvm_vendor") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(jvm_general_stats,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(StringLocalizer.StringLocalizer("mainwindow.statisticstab.tab.jvm.label.jvm_version") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(jvm_general_stats,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(StringLocalizer.StringLocalizer("mainwindow.statisticstab.tab.jvm.label.jvm_uptime") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		heapmemory_stats.setText(StringLocalizer.StringLocalizer("mainwindow.statisticstab.tab.jvm.group.heap_memory"));
		layout_data = new GridData(GridData.FILL_HORIZONTAL);
		...
		label.setFont(skin.getLabelFont());
		label.setText(StringLocalizer.StringLocalizer("mainwindow.statisticstab.tab.jvm.label.heapmemory_init") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(heapmemory_stats,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(StringLocalizer.StringLocalizer("mainwindow.statisticstab.tab.jvm.label.heapmemory_used") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(heapmemory_stats,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(StringLocalizer.StringLocalizer("mainwindow.statisticstab.tab.jvm.label.heapmemory_max") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		nonheapmemory_stats.setText(StringLocalizer.StringLocalizer("mainwindow.statisticstab.tab.jvm.group.nonheap_memory"));
		layout_data = new GridData(GridData.FILL_HORIZONTAL);
		...
		label.setFont(skin.getLabelFont());
		label.setText(StringLocalizer.StringLocalizer("mainwindow.statisticstab.tab.jvm.label.nonheapmemory_init") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(nonheapmemory_stats,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(StringLocalizer.StringLocalizer("mainwindow.statisticstab.tab.jvm.label.nonheapmemory_used") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(nonheapmemory_stats,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(StringLocalizer.StringLocalizer("mainwindow.statisticstab.tab.jvm.label.nonheapmemory_max") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		thread_stats.setText(StringLocalizer.StringLocalizer("mainwindow.statisticstab.tab.jvm.group.threads"));
		layout_data = new GridData(GridData.FILL_HORIZONTAL);
		...
		label.setFont(skin.getLabelFont());
		label.setText(StringLocalizer.StringLocalizer("mainwindow.statisticstab.tab.jvm.label.thread_count") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(thread_stats,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(StringLocalizer.StringLocalizer("mainwindow.statisticstab.tab.jvm.label.daemon_thread_count") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(thread_stats,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(StringLocalizer.StringLocalizer("mainwindow.statisticstab.tab.jvm.label.peak_thread_count") + " : ");
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		...
		label = new Label(thread_stats,SWT.NONE);
		label.setFont(skin.getLabelFont());
		label.setText(StringLocalizer.StringLocalizer("mainwindow.statisticstab.tab.jvm.label.total_thread_count") + " : ");
		label.setToolTipText(StringLocalizer.StringLocalizer("mainwindow.statisticstab.tab.jvm.label.total_thread_count.tooltip"));
		label.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		
		total_thread_count = new Label(thread_stats,SWT.NONE);
		total_thread_count.setFont(skin.getLabelFont());
		total_thread_count.setText(thread_bean.getTotalStartedThreadCount()+"");
		total_thread_count.setToolTipText(StringLocalizer.StringLocalizer("mainwindow.statisticstab.tab.jvm.label.total_thread_count.tooltip"));
