...

{
	...
	*/
	...
	serverConfig.load(new FileInputStream(new File("src/org/jmule/middleware/http").getAbsolutePath()+"/srm.conf"));
	mimeTypes.load(new FileInputStream(new File("src/org/jmule/middleware/http").getAbsolutePath()+"/mime.types"));
        int localport = -1;
